...
% Directory settings
SOURCE_DIRECTORY = 'C:\Users\michael\Desktop\f_proj\RGBtoHyper\base_hs_images\'; % Directory where source HS images may be found
%SOURCE_DIRECTORY = 'HyperData';
...
%load(fullfile(SOURCE_DIRECTORY, 'preprocessed_image_1.mat'), 'inferred_bands');
%bands = inferred_bands; % Use inferred bands from preprocessed data
...
% Resample cie_1964 to match the 205 bands
%original_bands_cie = linspace(400, 700, 31); % Adjust range if needed
%cie_1964_resampled = interp1(original_bands_cie, cie_1964, bands, 'linear', 'extrap');
...
disp('Done');
disp('');
save('hs_dictionaries.mat', 'Dic_HS', 'Dic_Cam', 'bands', 'cie_1964');
disp('Dictionaries saved to hs_dictionaries.mat.');
